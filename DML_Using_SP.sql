...
EXEC ADD_CUSTOMER(5555555555, 'Bob', 'Johnson', 'pass123', 'bob.johnson@example.com');
...
EXEC SAVED_ADDRESS('Home', '123 Main St', 'Boston', 'Massachusetts', 12345,1234567890);
EXEC SAVED_ADDRESS('Work', '39 west walnut', 'Boston', 'Massachusetts', 02115,1234567890);
EXEC SAVED_ADDRESS('Work', '456 Business Ave', 'Chicago', 'Illinois', 54321,9876543210);
EXEC SAVED_ADDRESS('Vacation Home', '789 Beach Blvd', 'New York', 'New York', 98765,5555555555);
EXEC SAVED_ADDRESS('Home', '101 Dimock street', 'Boston', 'Massachusetts', 11111,1112223333);
EXEC SAVED_ADDRESS('Office', '101 Corporate Lane', 'Boston', 'Massachusetts', 11111,1112223333);
EXEC SAVED_ADDRESS('Friends Place', '321 Friendship St', 'Nashville', 'Florida', 01234,1234567890);
...
--ADDING ORDERS USING SP

EXEC ADD_ORDER(5555555555, '123 Collection St', 54321, 'New York', 'New York', 98765, 
    '789 Beach Blvd', 'Ken', 8765432109, 'Bob', 
    'Handle with care', 3);
    
EXEC ADD_ORDER(1112223333, '101 Corporate Lane', 11111, 'Massachusetts', 'Boston', 11111, 
    '101 Dimock street', 'king', 4445556666, 'Emily',
    'Fragile items',4);
    
EXEC ADD_ORDER(4445556666, '555 Pickup Lane', 54321, 'Illinois', 'Chicago', 54321, 
    '456 Business Ave', 'Alice', 9876543210, 'Michael', 
    'Handle with extra care', 2 );
    
EXEC ADD_ORDER(9990001111, '39 west walnut', 87654, 'Massachusetts', 'Boston', 02115, 
    '123 Main St', 'John', 1234567890, 'Jude', 
    'Quick delivery requested', 1 );
    
EXEC ADD_ORDER(4445556666, '321 Friendship St', 11111, 'Florida', 'Nashville', 01234, 
    '789 Speedy St', 'Kane', 2223334444, 'Michael', 
    'Standard delivery drop in front of door', 5);


--Adding Items using SP
...
EXEC ADD_FEEDBACK(4,'Too costly' ,3, 0)
